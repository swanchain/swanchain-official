<template>
  <div class="font-28 font-bold2 mt-32 mb-16 flex flex-ai-center">
    Network Summary

    <div class="ex-link font-16 flex flex-ai-center ml-10 pointer" @click="openPage(ELINK.PROXIMAEXPLORER)">
      View in exolorer
  ...
  <el-row :gutter="16">
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        ...
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.counters.smart_contracts) }}</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Transactions</p>
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.value.total_transactions) }}</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Transactions (7 Days)</p>
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.value.transactions_today * 7) }}</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Total Blocks</p>
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.value.total_blocks) }}</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Gas Used (7 Days)</p>
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.value.gas_used_today * 7) }}</p>
      </div>
    </el-col>
    <!-- <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">ETH Price</p>
        <p class="font-24 color mt-8"></p>
      </div>
    </el-col> -->
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Market Cap</p>
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.value.market_cap) }}</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Wallet Address</p>
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.value.total_addresses) }}</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Gas tracker</p>
        <p class="font-24 color mt-8">{{ statsData.value.gas_prices?.average }} Gwei</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Average block time</p>
        <p class="font-24 color mt-8">{{ millisecondsToHMS(statsData.value.average_block_time) }}</p>
      </div>
    </el-col>
  </el-row>
  ...
  <div class="font-28 font-bold2 mt-32 mb-16 flex flex-ai-center">
    ...
    <div class="ex-link font-16 flex flex-ai-center ml-10 pointer" @click="openPage('https://orchestrator.swanchain.io/provider-status')">
      View in exolorer
  ...
  <el-row :gutter="16">
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        ...
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.overViewData.total_online_computers) }}</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">ECP</p>
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.ECPData.cp.total) }}</p>
      </div>
    </el-col>
    <!-- <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
    ...
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        ...
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.overViewData.total_cp_locations + statsData.ECPData.location.total) }}</p>
      </div>
    </el-col>
    <!-- <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
    ...
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        ...
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.generalData.total_task) }}</p>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :md="8" :lg="6" :xl="6" class="mt-16">
      <div class="grid-content">
        <p class="font-16">Total reward</p>
        <p class="font-24 color mt-8">{{ replaceFormat(statsData.ECPData.rewards.total) }} SWAN</p>
      </div>
    </el-col>
  </el-row>
</template>
