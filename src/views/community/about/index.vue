...
export default defineComponent({
  ...
  setup () {
    ...
    const teamImg = require('@/assets/images/about/teams-01.png')
    const bossImg = require('@/assets/images/about/person.png')
    const fundData = ref([
      {
    ...
    onMounted(() => { })
    return {
      system, teamImg, bossImg, fundData, needImg, mediaData,
      content_img
    }
  }
})
